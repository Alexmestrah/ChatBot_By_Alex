...
class Testing:
    def __init__(self):
        ...
        with open('data.json', 'r', encoding='utf-8') as json_file:
             self.data = json.load(json_file)        #load the training_data file which contains training data
    ...
    def response(self,sentence,userID='Alex'):
        ...
        if results:
            while results:
                ...
                results.pop(0)
        return ans if ans!="" else "Désolé ! J'apprends encore.\nVous pouvez m'entrainer en fournissant plus de données."
